...
This trend reveals a fundamental difference between the two components: while the classifier can maintain consistent predictive performance regardless of prefix length, the recommendation system requires a minimum threshold of contextual information (approximately 7 activities) before it can generate meaningful recommendations.
\begin{figure}[H]
    \centering
