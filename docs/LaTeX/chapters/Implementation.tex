...
To these columns, we also added the trace identifier, the prefix length and the ground truth label that indicates whether the trace outcome was positive or negative.
\\\\
