...
├── logs/                         # Compressed files (XES format)
│   ├── Production_avg_dur_training_0-80.xes.zip
│   └── Production_avg_dur_testing_80-100.xes.zip
...
1. Go to [https://github.com/andreablushi/Recommendation-System](https://github.com/andreablushi/Recommendation-System)
...
1. In the Jupyter file browser, click on `notebook.ipynb`
...
**1. Data Loading and Preprocessing**
   ...
   - Create trace prefixes of specified length
   - Apply boolean encoding to activities

**2. Decision Tree Classifier**
   - Hyperparameter optimization using hyperopt
   - Train decision tree on boolean-encoded prefixes
...
**4. Recommendations**
   - Extract positive paths from decision tree
...
- Wait for all cells to complete (may take several minutes)
